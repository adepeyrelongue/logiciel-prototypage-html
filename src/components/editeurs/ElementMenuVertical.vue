<template>
  <div class="form-group">
    <div class="col-xs-12">
      <fieldset>
        <legend>Rubrique de menu</legend>
        <div class="form-group">
          ...
          <div class="col-xs-12 col-md-4">
            <div class="checkbox">
              <label for="ib-active">
                <input id="ib-active" type="checkbox" name="ib-active" v-model="active_">
                Rubrique active
              </label>
            </div>
          </div>
